// case-studies/project-one.tsx
export default function CaseStudyOne() {
  return (
    <>
      <p>
        Hello! I'm a multidisciplinary designer with a background in interaction
        design, product strategy, and user research. My work bridges intuitive
        interfaces, elegant motion, and deeply human problem-solving. I have
        experience across startups, institutional design teams, and
        collaborative community projects. I thrive in ambiguity, build clarity
        through research and iteration, and obsess over how people actually use
        things.
      </p>
      <p>
