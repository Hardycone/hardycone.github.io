  ...
  return (
    <main className="max-w-3xl mx-auto p-8 prose">
      ...
      <p>
        ...
        for lunar and Martian missions. Our team—a mix of engineers, designers,
        and scientists—tackled this frontier: what should astronauts see in
        their HUDs while exploring alien terrain?
      </p>
      ...
      <p>
        ...
        using AR headsets in outdoor settings to replicate astronaut tasks like
        sample collection and terrain scanning.
      </p>

      <h2>Design</h2>
      <p>
        Our system focused on four key features: Geospatial Awareness: real-time
        path mapping and waypoint marking Task Guidance: visual instructions
        synced with mission protocols Environmental Alerts: on-HUD hazard cues
        (e.g. radiation zones) Team Comms: minimalist indicators of other
        astronauts' positions We used HoloLens 2 as a development platform.
        Design focused on minimizing cognitive load and ensuring info was
        glanceable. Voice and gesture controls were optimized for gloves and
        limited dexterity.
      </p>
