...
export default function CaseStudyFigure({
  ...
  return (
    <figure className="overflow-hidden rounded-1 border border-foreground/10 bg-zinc-50 supports-[corner-shape:squircle]:rounded-2 supports-[corner-shape:squircle]:[corner-shape:squircle] dark:border-dark-foreground/15 dark:bg-zinc-800 md:rounded-2 supports-[corner-shape:squircle]:md:rounded-4">
      <div
