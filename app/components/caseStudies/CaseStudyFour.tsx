    ...
    <article>
      ...
      <section id="section-2" className="scroll-mt-24">
        ...
        >
          ...
          <p className="mb-10 text-pretty px-2">
            NASA supplied a task list rather than a conventional product brief.
            We translated it into a continuous journey, including failure-prone
            handoffs between navigation, communication, telemetry, and science.
          </p>
          <HorizontalFilmstrip
            body={
              <>
                <SubSectionHeading number="2" heading="The simulated mission" />
              ...
              },
              {
                ...
                content: (
                  <>
                    ...
                    <p className="mt-3">
                      Use recorded waypoints to retrace the route and close the
                      EVA.
                    </p>
                  </>
                ),
      ...
      <section id="section-3" className="scroll-mt-24">
        ...
        >
          ...
          />
          <p className="mb-10 text-pretty px-2">
            A headset can display almost anything; that made restraint the core
            design problem. Persistent information was limited to mission state,
            safety, and orientation. Everything else appeared when the task
            required it.
          </p>
      ...
      <section id="section-5" className="scroll-mt-24">
        <SectionContainer
          ...
          borderColor={borderColor}
        >
          <SubSectionHeading number="1" heading="NASA Rock Yard, after dark" />
          <p className="mb-8 text-pretty px-2">
            As a SUITS finalist, the team brought the prototype to Johnson Space
            Center. NASA engineers ran the simulated EVA in the Rock Yard at
            night, giving us a realistic test of navigation, legibility, task
            flow, and system coordination.
          </p>
          <p
          ...
          >
            The most meaningful outcome was not a polished demo. It was watching
            a complete mission workflow survive contact with the environment it
            was designed for.
          </p>
        </SectionContainer>
      </section>
