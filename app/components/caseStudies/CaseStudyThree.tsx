    ...
    <article>
      <section id="section-1" className="scroll-mt-24">
        ...
        >
          ...
          <p>
            Filmmakers often have great ideas but struggle to translate them
            into structured scripts and visual plans. We partnered with a team
            of indie filmmakers and technologists to create a tool that helps
            storytellers go from premise to production—with AI-enhanced tools
            for storyboarding and voice.
          </p>{" "}
          <p>
            Filmmakers often have great ideas but struggle to translate them
            into structured scripts and visual plans. We partnered with a team
      ...
      <section id="section-2" className="scroll-mt-24">
        ...
        >
          ...
          <p>
            ...
            production teams. They described a fragmented process: notes in
            Google Docs, sketches in notebooks, and scattered tools for
            voiceover and visualization. What they wanted was creative
            momentum—tools that support flow, not friction. We also studied
            screenwriting and story structure pedagogy, integrating ideas from
            Save the Cat and The Hero’s Journey to inform potential prompts and
            scaffolds.
          </p>
          <p>
            We ran discovery sessions with 15 independent creators and small
