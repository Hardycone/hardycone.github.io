        ...
        >
          <SubSection spacing="none">
            <p className="mb-6">
              ...
              data? While qualitative methods dominate early design, we noticed
              a gap in quant UX tooling, particularly for live prototype
              testing. We wanted to bring statistical rigor to the kinds of
              questions teams already ask in Figma: which variant performs
              better? Where do users hesitate?
            </p>
            <div
        ...
        >
          <SubSection spacing="none">
            ...
            <p>
              ...
              alike engaged with the stories woven into the space. A local
              newspaper called it “a love letter in bricks and light.” It also
